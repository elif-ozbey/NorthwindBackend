...
namespace Core.Extensions
{
    public  static class ClaimExtensions
    {
        ...
        public static void AddEmail(this ICollection<Claim> claims, string email)//thisden sonra yazdigimiz ilk virgul oncesi neyi extend edecegimiz, hangi parametreyi gonderecegiz
        {
